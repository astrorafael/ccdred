# FINDGAIN2 - calculate the gain and readnoise given two flats and two
...
procedure findgain2 (flat1, flat2, zero1, zero2)
...
begin
	...
	if (verbose) {
	    ...
	    printf ("\n  Flats      = %s  &  %s\n", lf1, lf2)
	    printf ("  Zeros      = %s  &  %s\n", lz1, lz2)
	    printf ("  Gain       = %g electrons per ADU\n", e_per_adu)
	    printf ("  Read noise = %g electrons\n", readnoise)
	} else
	    printf ("%g\t%g\n", e_per_adu, readnoise)
end
